...
class Update_Customer extends Add_Customer implements ActionListener{
    ...
    Update_Customer(String idaa){
        ...
        id15.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("customer/icons/add_employee.jpg"));
        id15.setIcon(img);

        id8 = new JLabel("Update Customer Detail:");
    ...
    public static void main(String[] arg){
        new Update_Customer("Update Customer");
    }
}
...
class Remove_Customer implements ActionListener{
    JFrame f;
    JTextField t;
    ...
    Remove_Customer(){
        ...
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("customer/icons/remove.jpg"));
        l5.setIcon(img);
        f.add(l5);
